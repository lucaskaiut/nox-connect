export const Permission = {
  ...
  WHATSAPP_TEMPLATE_READ: 'whatsapp.template.read',
  WHATSAPP_TEMPLATE_UPDATE: 'whatsapp.template.update',
  WHATSAPP_TEMPLATE_DELETE: 'whatsapp.template.delete',
...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      { value: Permission.WHATSAPP_TEMPLATE_READ, label: 'Visualizar templates' },
      { value: Permission.WHATSAPP_TEMPLATE_CREATE, label: 'Criar templates' },
      { value: Permission.WHATSAPP_TEMPLATE_UPDATE, label: 'Editar templates' },
      { value: Permission.WHATSAPP_TEMPLATE_DELETE, label: 'Remover templates' },
    ],
  },
  {
    label: 'Assinaturas',
